...
$scriptPath = Join-Path -Path $PSScriptRoot -ChildPath "Invoke-LobsterDataMaintenance.ps1"
if (-not (Test-Path $scriptPath)) {
  throw "Invoke-LobsterDataMaintenance.ps1 wurde nicht gefunden neben diesem Launcher: $scriptPath"
}
